...
<html lang="en-us" class="no-js">
	...
	<head>
        ...
        <meta name="description" content="IVAO Colombia - Les permite volar y/o controlar en el ambiente simulado más realista posible, incluso con meteorología del mundo real, Usted puede recibir entrenamiento y disfrutar de nuestra comunidad totalmente gratuito.">
		...
		<!--	<li class="google-color">
			...
			<li class="instagram-color">
				...
				<li class="facebook-color">
					<a  target="_blanck" href="https://www.facebook.com/ivaoco/" title="">
			...
			<div class="portfolio">
				...
				<div class="col-xs-12 col-sm-6 col-lg-6">
					...
					<div class="col-xs-12 col-sm-6 col-lg-6">
						...
						<a href="https://www.ivao.aero/vasystem/country.asp?ID=CO" title="Virtual Airlines" class="swipebox">

						<div class="small-square fourth">

							<div class="hover-info">
					            <h4>Airlines of Colombia</h4>
