	...
	?>
      <div class="row">
        <div class="heading text-center col-sm-8 col-sm-offset-2 wow fadeInUp" data-wow-duration="1200ms" data-wow-delay="300ms">
          <h2>Colombia's Virtual Airlines</h2>
          <p>You can be part of any of these <?php echo $ippii; ?> Virtual Airlines that IVAO Colombia Division has.</p>
        </div>
      </div>
	...
	?>
         ...
         <div class="col-sm-4 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="600ms">
            ...
            <div class="entry-content">
              <span><i class="fa fa-globe"></i> Web: <a target="_blanck" href="<?php echo $web; ?>">See Web</a></span>
            </div>
			 <div class="social-icons">
                <ul>
               <center>
                    <a class="facebook" href="?page=infoairlines&id=<?php echo  $callsign; ?>"><i class="fa fa-chevron-right"></i> SEE INFORMATION</a></center>
                </ul>
              </div>
          </div>
