...
<thead>
  <tr class="princ">
    <th>ATC en Linea IVAO CO</th><th>Staff IVAO CO</th>
  </tr>
</thead>
<tbody>
...
<h2>Pilotos en línea</h2>
<table cellpadding="0" cellspacing="0" class="trafficlisttable" width="100%">
<tr class="princ">
<td>Operador</td><td>Callsign</td><td>Salida</td><td>Llegada</td><td>Información</td></tr>
<tr class='trafico'>
...
<td>
<input class='boton' type='button' name='button' id='button' value='Ver' target="_self" onclick='window.open("./?page=flighttracks&cs=<?php echo $pilot[0]; ?>")' /></input></td>
</tr>
<?
   }
