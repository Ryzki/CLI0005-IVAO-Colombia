...
function registerPosition(vid,name,id,modalID) {
	...
	$.ajax({
		...
		$("#modalFlightsbody").html('<div class="alert alert-success"><h4>Well Done!</h4><br/>The flight has been booked succesfully!<br/><br/>Stand by for the page\'s automatic reload.</div>');
