...
// Localhost
$rfedatabase = "rfe";      // Database which will contain the flights' data
$navdatabase = "navdata";  // Database which will contain the navdata
$login_db    = "root";     // MySQL's login
$pass_db     = "root";     // MySQL's password
$port        = "";         // MySQL's port (if needed)
// Website
