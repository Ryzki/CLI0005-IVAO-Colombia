...
<footer id="footer">
	<div class="container">
		<div class="row">
			<div class="span3"  style="padding-left: 20px; background: linear-gradient(to bottom, rgba(44, 17, 14,0.85) 0%,rgba(44, 17, 14,0.3) 150%),0% 0%/45% no-repeat url(./images/header0.jpg);width:100%;height:20px;">
